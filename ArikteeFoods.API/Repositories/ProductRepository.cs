...
namespace ArikteeFoods.API.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<Product?> GetProduct(int Id) => await _arikteeDbContext.Products.Include(e => e.ProductUnits).FirstOrDefaultAsync(e => e.Id == Id);

        public async Task<IEnumerable<Product>> GetProducts() => await _arikteeDbContext.Products.Include(e => e.ProductUnits).ToListAsync();
    }
}
